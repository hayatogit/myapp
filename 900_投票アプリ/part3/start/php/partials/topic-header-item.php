...
?>
  <div>
    <?php if ($from_top_page) : ?>
      <h1 class="sr-onry">みんなのアンケート</h1>
      <h2 class="h1">
        <a class="text-body" href="<?php the_url('topic/datail?topic_id=' . $topic->id); ?>">
...
?>
  ...
  <?php else : ?>
    <div class="text-center mt-5">
      <div class="mb-2">ログインしてアンケートに応募しよう！</div>
      <a href="<?php echo the_url('login'); ?>" class="btn btn-success btn-lg">ログインはこちら！</a>
    </div>
  <?php endif; ?>
<?php
}
